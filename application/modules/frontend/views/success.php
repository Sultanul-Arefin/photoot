                ...
                <div class="container">
                    <div class="row bank">
                        ...
                        <div class="col-md-12" id="">
                                ...
                                <p>Your order has been saved with the number <b style="color: red"><?=$value->order_id;?></b>, and a summary email has been sent to your email address <b style="color: red"><?=$value->email;?></b> used for registration to our site.</p>
                                <p> Check in the next few minutes.</p>
                                <h4>TOTAL ORDER VAT included <b style="color: red;">
                                    <?php
                                        $price = 0;
                                        $order = $value->order_info; 
                                        $total_decode = json_decode($order);
                                        foreach($total_decode as $total){
                            ...
                            <p style="color: red;">CAUSALE: <?=$value->order_id;?></p>
                            <p style="color: red;">IMPORTO: <?= $price; ?></p>
                            <p>--</p>
