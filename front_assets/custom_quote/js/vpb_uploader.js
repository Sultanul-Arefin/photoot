...
function vpb_multiple_file_uploaders(vpb_configuration_settings)
{
		...
		if(this.vpb_files.length > 0)
		{
 			...
 			for(var i = 0; i<this.vpb_files.length; i++)
			{
				...
				if(typeof this.vpb_files[i] != undefined && this.vpb_files[i].name != "")
				{
					...
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/images_file.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "doc" || vpb_file_to_add == "docx" || vpb_file_to_add == "rtf" || vpb_file_to_add == "DOC" || vpb_file_to_add == "DOCX" )
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/doc.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "pdf" || vpb_file_to_add == "PDF" )
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/pdf.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "txt" || vpb_file_to_add == "TXT" || vpb_file_to_add == "RTF" )
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/txt.png" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "php" )
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/php.png" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "css" )
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/general.png" align="absmiddle" border="0" alt="" />';
					}
					...
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/html.png" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "setup" )
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/setup.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "video" )
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/video.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "real" )
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/real.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "psd" )
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/psd.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "fla" )
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/fla.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "xls" )
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/xls.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "swf" )
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/swf.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "eps" )
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/eps.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "exe" )
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/exe.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "binary" )
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/binary.png" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "zip" )
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/archive.png" align="absmiddle" border="0" alt="" />';
					}
					else
					{
						vpb_file_icon = '<img src="../../../../front_assets/custom_quote/images/general.png" align="absmiddle" border="0" alt="" />';
	...
	vpb_multiple_file_uploaders.prototype.vasPLUS = function(file,file_counter)
	{
		if(typeof file[file_counter] != undefined && file[file_counter] != '')
		{
			...
			var custom_quote_value = $('input[name="custom_quote_value"]').val();
			...
			else
			{
				...
				dataString.append('custom_quote_value', custom_quote_value);
